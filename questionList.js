const questionList = [
    ...
    },
    {
        ...
        "Category": "Marvel",
        "List": [
            new Question("Hangi Marvel filmi, En İyi Film dalında Oscar kazanmıştır?", { a: "Black Panther", b: "Avengers: Endgame", c: "Captain America: The Winter Soldier", d: "Spider-Man: Into the Spider-Verse" }, "a"),
            new Question("Hangi karakter, 'Captain America: Civil War' filminde Black Panther olarak ilk kez yer almıştır?", { a: "T'Challa", b: "N'Jadaka", c: "Okoye", d: "Shuri" }, "a"),
            new Question("Hangi karakter, 'Spider-Man: Far From Home' filminde başrol oynamaktadır?", { a: "Peter Parker", b: "Tony Stark", c: "Steve Rogers", d: "Bruce Banner" }, "a"),
            new Question("Hangi karakter, 'Guardians of the Galaxy Vol. 2' filminde kendi babasını öldürmüştür?", { a: "Gamora", b: "Drax", c: "Rocket", d: "Star-Lord" }, "d"),
            new Question("Hangi karakter, 'Iron Man 3' filminde Mandarin olarak tanıtılmıştır?", { a: "Aldrich Killian", b: "Trevor Slattery", c: "Happy Hogan", d: "J.A.R.V.I.S." }, "b"),
            new Question("Hangi karakter, 'Captain America: The Winter Soldier' filminde S.H.I.E.L.D.'ın kökünü kazımıştır?", { a: "Alexander Pierce", b: "Brock Rumlow", c: "Jasper Sitwell", d: "Sharon Carter" }, "a"),
            new Question("Hangi taşın gücü, 'Guardians of the Galaxy' filminde ele geçirilmiştir?", { a: "Zihin Taşı", b: "Güç Taşı", c: "Gerçeklik Taşı", d: "Ruh Taşı" }, "c"),
            new Question("Hangi karakter, 'Avengers: Endgame' filminde Thanos'u yendi?", { a: "Iron Man", b: "Captain America", c: "Thor", d: "Hulk" }, "a"),
            new Question("Hangi karakter, 'Doctor Strange' filminde başrol oynamaktadır?", { a: "Tony Stark", b: "Stephen Strange", c: "Peter Parker", d: "Wade Wilson" }, "b"),
            new Question("Hangi karakter, 'Spider-Man: Homecoming' filminde başrol oynamaktadır?", { a: "Peter Parker", b: "Tony Stark", c: "Steve Rogers", d: "Bruce Banner" }, "a"),
            new Question("Hangi karakter, 'Ant-Man' filminde başrol oynamaktadır?", { a: "Scott Lang", b: "Hank Pym", c: "Hope Van Dyne", d: "Janet Van Dyne" }, "a"),
            new Question("Hangi karakter, 'Thor: Ragnarok' filminde başrol oynamaktadır?", { a: "Loki", b: "Odin", c: "Thor", d: "Hela" }, "c"),
            new Question("Hangi karakter, 'Guardians of the Galaxy' filminde liderlik rolünü üstlenmiştir?", { a: "Gamora", b: "Drax", c: "Rocket", d: "Star-Lord" }, "d"),
            new Question("Hangi karakter, 'Black Panther' filminde başrol oynamaktadır?", { a: "T'Challa", b: "N'Jadaka", c: "Okoye", d: "Shuri" }, "a"),
            new Question("Hangi karakter, 'Captain America: The First Avenger' filminde başrol oynamaktadır?", { a: "Bucky Barnes", b: "Steve Rogers", c: "Peggy Carter", d: "Red Skull" }, "b"),
            new Question("Hangi karakter, 'Iron Man' filminde başrol oynamaktadır?", { a: "Tony Stark", b: "Pepper Potts", c: "James Rhodes", d: "Obadiah Stane" }, "a"),
            new Question("Hangi karakter, 'Shang-Chi and the Legend of the Ten Rings' filminde başrol oynayacak?", { a: "Shang-Chi", b: "Wenwu", c: "Jiang Nan", d: "Razor Fist" }, "a"),
            new Question("Hangi karakterin gerçek adı Steve Rogers'dır?", { a: "Iron Man", b: "Thor", c: "Captain America", d: "Spider-Man" }, "c"),
            new Question("Dr. Strange'in gerçek adı nedir?", { a: "Stephen Strange", b: "Scott Summers", c: "Peter Parker", d: "Bruce Banner" }, "a"),
            new Question("Deadpool'un gerçek adı nedir?", { a: "Wade Wilson", b: "Logan", c: "Tony Stark", d: "Matt Murdock" }, "a"),
            new Question("Hangi karakter, büyük yeşil bir yaratığa dönüşebilir?", { a: "Wolverine", b: "The Thing", c: "Hulk", d: "Colossus" }, "c"),
            new Question("Hangi karakter, ölümsüzdür?", { a: "Captain America", b: "Black Panther", c: "Spider-Man", d: "Wolverine" }, "d"),
            new Question("Hangi karakterin gerçek adı Natasha Romanoff'dur?", { a: "Black Widow", b: "Scarlet Witch", c: "Mystique", d: "Gamora" }, "a"),
            new Question("Hangi karakter, Thor'un kardeşidir?", { a: "Loki", b: "Ultron", c: "Thanos", d: "Drax" }, "a"),
            new Question("Hangi karakter, bir örümcek tarafından ısırıldıktan sonra örümcek güçleri kazanmıştır?", { a: "Iron Man", b: "Daredevil", c: "Luke Cage", d: "Spider-Man" }, "d"),
            new Question("Hangi karakter, siyah bir panter kostümü giyer?", { a: "Black Panther", b: "Falcon", c: "War Machine", d: "Blade" }, "a"),
            new Question("Hangi karakter, bir zırh giyerek savaşır?", { a: "Doctor Strange", b: "Iron Man", c: "Ant-Man", d: "The Vision" }, "b"),
            new Question("Hangi karakter, bir mutanttır?", { a: "Black Widow", b: "Jean Grey", c: "Gamora", d: "Wasp" }, "b"),
            new Question("Hangi karakter, süper hızlı bir şekilde koşabilir?", { a: "The Flash", b: "Spider-Man", c: "Quicksilver", d: "Ant-Man" }, "c"),
            new Question("Hangi karakter, ok kullanmakta ustadır?", { a: "Hawkeye", b: "The Punisher", c: "Deadpool", d: "Wolverine" }, "a"),
            new Question("Hangi karakter, bir grup uzaylı tarafından kaçırıldıktan sonra dünya dışı yetenekler kazanmıştır?", { a: "Nova", b: "Star-Lord", c: "Captain Marvel", d: "Ms. Marvel" }, "c"),
